...
<h2>Add New Scheduled Backup</h2>
	<img src="<?php echo $this->_pluginURL.'/images/bullet_error.png'; ?>" style="vertical-align: -3px;" /> IMPORTANT: For scheduled events to occur someone (or you) must visit this site on or after the scheduled time.<br /><br />
