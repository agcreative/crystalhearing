...
if ( !class_exists( 'PluginBuddyImportBuddy' ) ) {
	class PluginBuddyImportBuddy {
		...
		function view_step_1() {
			...
			For support see our <a href="http://ithemes.com/codex/page/BackupBuddy" target="_blank">troubleshooting resource links</a> or <a href="http://pluginbuddy.com/support/" target="_blank">support forum</a>.
